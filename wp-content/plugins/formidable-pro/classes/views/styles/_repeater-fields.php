...
<div class="frm6 frm_form_field">
	...
	<input type="text" name="<?php echo esc_attr( $frm_style->get_field_name( 'repeat_icon_color' ) ); ?>" id="frm_repeat_icon_color" class="hex" value="<?php echo esc_attr( $style->post_content['repeat_icon_color'] ); ?>" />
</div>
